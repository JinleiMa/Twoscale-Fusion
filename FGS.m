...
% 
%  F = FGS(img, joint_image, sigma, lambda, num_iterations, attenuation)
%
%  Parameters:
...
%
% The code was implemented using C++ with a MATLAB interface (mex file). 
% Please compile C++ files by running 'compile.m' or using the following command: 'mex mexFGS_simple.cpp'.
%
...
function F = FGS(img, joint_image, sigma, lambda, num_iterations, attenuation)
